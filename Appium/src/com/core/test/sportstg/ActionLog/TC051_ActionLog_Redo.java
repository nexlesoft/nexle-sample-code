...
public class TC051_ActionLog_Redo extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC051_ActionLog_redo() throws Exception {
		/*********************************************
		...
		actionLog.verifyActionLogScreenDisplayed()
		         .synchronizeLongLoadingPage()
		         .verifyPointsActionLog(point)
		         .synchronizePage()
		         .clickEditIconActionLogScreen()
		         .synchronizePage()
		         .clickTwoPointActionLogScreen()
		         .synchronizePage()
		         .clickSaveButtonActionLog()
		         .synchronizeLongLoadingPage()
		         .verifyPointsActionLog("2")
		         .synchronizePage()
		         .verifyLogStatusChangeScore()
		         .synchronizeLongLoadingPage()
		         .clickBackButton()
		         .synchronizeLongLoadingPage();
		         
		         
		gameTime.verifyTotalScoreOfLeftTeam("02")
				.synchronizePage()
				.clickUndoLastButton()
				.synchronizePage()
				.clickRedoButton()
				.synchronizePage()
				.verifyTotalScoreOfLeftTeam("02")
				.synchronizeLongLoadingPage()
				.clickActionLogButton()
				.synchronizeLongLoadingPage();

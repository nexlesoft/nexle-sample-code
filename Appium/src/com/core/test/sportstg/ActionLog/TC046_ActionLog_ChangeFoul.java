...
public class TC046_ActionLog_ChangeFoul extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC046_ActionLog_changeFoul() throws Exception {
		/*********************************************
		...
		actionLog.verifyActionLogScreenDisplayed()
		         ...
		         .synchronizePage()
		         .clickTechnicalFoulActionLogScreen()
		         .synchronizePage()
		         .clickSaveButtonActionLog()
		         .synchronizeLongLoadingPage()
		         .verifyLogStatusChangeToTechnicalFoul()
		         .synchronizePage()
		         .clickBackButton()
		         .synchronizeLongLoadingPage();

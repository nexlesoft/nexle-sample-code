...
public class TC053_TeamSelectionList_TapRefreshButton extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC053_TeamSelectionList_tapRefreshButton() throws Exception {
		/*********************************************
		...
		/**Change team button**/
		teamSelection.tapRefreshButton()
		             .synchronizeLongLoadingPage()
		             .synchronizeLongLoadingPage()
		             .clickBackButton()
		             .synchronizeLongLoadingPage();

...
public class TC017_TeamSelectionList_EditTeamColor extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC017_TeamSelectionList_editTeamColor() throws Exception {
		/*********************************************
		...
		teamSelection.verifyTeamListDisplayed()
					 .clickEditTeamColours()
					 .synchronizeLongLoadingPage()
					 .verifyEditTeamColoursPopupDisplayed()
					 .synchronizePage()
					 .clickCancelBtn()
					 .synchronizePage()
					 .clickBackButton()

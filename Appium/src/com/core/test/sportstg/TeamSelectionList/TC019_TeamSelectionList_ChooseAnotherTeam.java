...
public class TC019_TeamSelectionList_ChooseAnotherTeam extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC019_TeamSelectionList_chooseAnotherTeam() throws Exception {
		/*********************************************
		...
		/**Change team button**/
		teamSelection.clickBlueTeamHeader()
				     .synchronizePage()
				     .clickRedTeamHeader()
				     .synchronizePage()
					 .clickBackButton()

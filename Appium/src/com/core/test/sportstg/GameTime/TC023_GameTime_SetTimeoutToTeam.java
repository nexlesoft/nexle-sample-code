...
public class TC023_GameTime_SetTimeoutToTeam extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC023_GameTime_setTimeoutToTeam() throws Exception {
		/*********************************************
		...
		timeoutCount = gameTime.getTimeoutCountOfLeftTeam();
		...
		/**Tapping timeout button**/
				.tappingTimeoutBtn()
				.synchronizePage();
		remainingTimeoutCount = Integer.valueOf(timeoutCount) - 1;
		
		/**Verify timeout count is distracted by 1***/
		gameTime.verifyTimeoutCountInLeftTeam(String.valueOf(remainingTimeoutCount))
		        .synchronizePage()

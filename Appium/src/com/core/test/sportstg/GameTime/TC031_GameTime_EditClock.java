...
public class TC031_GameTime_EditClock extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC031_GameTime_editClock() throws Exception {
		/*********************************************
		...
		/**Click edit Clock button**/
				.clickEditClockButton()
		        .synchronizeLongLoadingPage()
		        .clickSetToZeroButton()
		        .synchronizePage()
		        .clickDoneButton()
		        .synchronizeLongLoadingPage()
		        .verifyTimeCountWhenClickEditClock("00:00")
		        .synchronizeLongLoadingPage()

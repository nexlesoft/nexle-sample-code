...
public class TC025_GameTime_SetTechnicalFoulToPlayer extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC025_GameTime_setTechnicalFoulToPlayer() throws Exception {
		/*********************************************
		...
		/**Verify foul count in Game Time screen**/
				...
				.synchronizePage()
				.verifyTechnicalFoulCountInLeftTeamForPlayer("1")
				.synchronizePage()

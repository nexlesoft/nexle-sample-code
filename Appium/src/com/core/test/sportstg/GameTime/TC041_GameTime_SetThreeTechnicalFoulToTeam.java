...
public class TC041_GameTime_SetThreeTechnicalFoulToTeam extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC041_GameTime_setThreeTechnicalFoulToTeam() throws Exception {
		/*********************************************
		...
		gameTime.verifyCourtName(courtName)
				.synchronizePage()
		/**Click team name in left side at first time**/
				.tappingTeamNameOfLeftSide()
				.synchronizePage()
		...
		/**Click team name in left side at second time**/
				.tappingTeamNameOfLeftSide()
				.synchronizePage()
		/**Verify text in notification bar**/
				.verifyTextNotificationBarClickAnyTeamName()
		...
		/**Click team name in left side at third time**/
				.tappingTeamNameOfLeftSide()
				.synchronizePage()
		/**Verify text in notification bar**/
				.verifyTextNotificationBarClickAnyTeamName()
		/**Tapping Technical Foul button**/
				.clickTechnicalFoulButton()
				.synchronizePage()
		/**Verify coach is disqualified in left team***/
				.verifyCoachIsDisqualifiedInLeftTeam()
				.synchronizeLongLoadingPage()

...
public class TC022_GameTime_AddScoreToTeam extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC022_GameTime_addScoreToTeam() throws Exception {
		/*********************************************
		...
		/**Enter data for Court ID, Setup ID, then press Enter to login the system**/
			 ...
			 .synchronizeLongLoadingPageForLogin()
		...
		gameTime.verifyCourtName(courtName)
				.synchronizeLongLoadingPage()
		/**Tap the team name in the left side**/

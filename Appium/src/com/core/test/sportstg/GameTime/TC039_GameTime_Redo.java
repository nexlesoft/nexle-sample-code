...
public class TC039_GameTime_Redo extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC039_GameTime_redo() throws Exception {
		/*********************************************
		...
		/**Verify total score in Game Time screen**/
				...
				.clickUndoLastButton()
				.synchronizePage()
				.verifyTotalScoreOfLeftTeam("00")
				.synchronizePage()
				.clickRedoButton()
				.synchronizePage()
				.verifyTotalScoreOfLeftTeam("0"+point)
				.synchronizePage()

...
public class TC026_GameTime_SetTechnicalFoulToTeam extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC026_GameTime_setTechnicalFoulToTeam() throws Exception {
		/*********************************************
		...
		/**Verify technical foul in team***/
				.verifyTechnicalFoulCountInLeftTeamForTeam("1")

...
public class TC028_GameTime_SetUnsportmanlikeFoulToPlayer extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC028_GameTime_setUnsportmanlikeFoulToPlayer() throws Exception {
		/*********************************************
		...
		/**Click unsportmanlike Foul button**/
				.clickUnsportmanlikeFoulButton()
				.synchronizeLongLoadingPage()
		/**Verify foul count in Game Time screen**/
				.verifyFoulCountInLeftTeam("1")
				.synchronizePage()
				.verifyUnsportmanlikeFoulCountInLeftTeam("1")
				.synchronizePage()

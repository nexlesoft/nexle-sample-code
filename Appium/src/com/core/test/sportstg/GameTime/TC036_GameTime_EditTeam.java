...
public class TC036_GameTime_EditTeam extends BaseTest {

	@Category({Regression.class})
	@Test
	public void TC036_GameTime_editTeam() throws Exception {
		...
		final int editAddPlayersOfTeam1 = Integer.parseInt(xmlReader.getValue("editAddPlayersOfTeam1"));
		...
		gameTime.clickEditIconOfLeftTeam()
		        .synchronizeLongLoadingPage();
		 /**Add more player for left team**/
		teamSelection.verifyPlayingInThisGameDisplayed()
					 .addPlayersToTeam(editAddPlayersOfTeam1)
		             .synchronizeLongLoadingPage()
		             .clickFinishSetupButton()
		             .synchronizeLongLoadingPage();
